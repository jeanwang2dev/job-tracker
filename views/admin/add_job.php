...
/* Build Page */
echo $PageData->setHeading("Add Job");
...
<body>
    ...
    <?php echo $PageData->mainTop("Please select an account name to add the job to."); ?>
         ...
         <div class="col-8">
            <form method="post" action="">
              	...
              	<div class="row form-group">                       
                    <div class="col-7">
          						<select class="custom-select" id="aj_account_name">
